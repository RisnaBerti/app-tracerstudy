    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ url('kuesioner-alumni') }}" class="waves-effect"><i class="mdi mdi-checkbox-multiple-marked-outline"></i>
                        <span>Kuesioner</span></a>
                </li>
                <li>
                    <a href="{{ url('kuesioner-history-alumni') }}" class="waves-effect"><i class="mdi mdi-format-list-checks"></i>
