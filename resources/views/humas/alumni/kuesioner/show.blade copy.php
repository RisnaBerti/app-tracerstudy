            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Textual form controls—like <code>input</code>s,<code> selects</code>,
                            and<code> textare</code>s—are styled with the .form-control class. Included are styles for
                            general appearance, focus state, sizing, and more. </p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Here’s a quick example to demonstrate Bootstrap’s form styles. Keep
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Create horizontal forms with the grid by adding the <code>.row</code>
                            class to form groups and using the <code>.col-*-*</code> classes to specify the width of your
                            labels and controls. Be sure to add <code>.col-form-label</code> to your
                            <code>&lt;label&gt;</code>s as well so they’re vertically centered with their associated form
                            controls.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Each checkbox and radio <code>&lt;input&gt;</code> and
                            <code>&lt;label&gt;</code> pairing is wrapped in a <code>&lt;div&gt;</code> to create our custom
                            control. Structurally, this is the same approach as our default <code>.form-check</code>.</p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Set heights using classes like <code>.form-control-lg</code> and
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Be sure to use <code>.col-form-label-sm</code> or
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4">Easily extend form controls by adding text, buttons, or button groups
                            on either side of textual inputs, custom selects, and custom file inputs</p>
                ...
                <div class="card">
                    <div class="card-body">
                        <h2  class="card-title mb-2 text-gray-800">{{ $kuesioner->judul_kuesioner }}</h2>
