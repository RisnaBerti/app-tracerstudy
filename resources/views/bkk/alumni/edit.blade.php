                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" id="nisn" name="nisn"
                                        value="{{ $alumni->nisn }}" placeholder="Nomor Induk Siswa Nasional" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" id="nama_alumni" name="nama_alumni"
                                        value="{{ $alumni->nama_alumni }}" placeholder="Nama lengkap" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-6">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" id="alamat_alumni" name="alamat_alumni"
                                        value="{{ $alumni->alamat_alumni }}" placeholder="Alamat" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" id="no_hp_alumni" name="no_hp_alumni"
                                        value="{{ $alumni->no_hp_alumni }}" placeholder="No HP" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-6 ">
                                    ...
                                    <input type="email" class="form-control" id="email_alumni" name="email_alumni"
                                        value="{{ $alumni->email_alumni }}" placeholder="Email" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-6">
                                    ...
                                    @if ($alumni->foto_alumni)
                                        <img src="{{ asset('uploads/alumni/' . $alumni->foto_alumni) }}" alt="foto"
