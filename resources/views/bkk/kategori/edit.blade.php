            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('kategori-update') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="col-md-4 mb-12">
                                    ...
                                    <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" id="nama_kategori"
                                        placeholder="Nama Kategori" value="{{ $kategori->nama_kategori }}" required>
                            ...
                            <div class="form-group">
                                <div class="col-md-4 mb-12">
                                    ...
                                    <input type="text" class="form-control" id="no_urut_tampil" name="no_urut_tampil" id="no_urut_tampil"
                                        placeholder="No Urut" value="{{ $kategori->no_urut_tampil }}" required>
                                    {{-- <div class="valid-feedback">
                                        Looks good!
                                    </div> --}}
                                </div>
                            ...
                            {{-- batal --}}
                            <a href="{{ route('kategori') }}" class="btn btn-light waves-effect waves-light">Batal</a>
                        </form>
