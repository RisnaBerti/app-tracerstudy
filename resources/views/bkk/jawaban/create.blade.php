            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('jawaban-store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-md-4 mb-12">
                                    <label for="nisn">Alumni</label>
                                    <input type="text" class="form-control" id="nisn" name="nisn"
                                        placeholder="Alumni" value="" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-4 mb-12">
                                    <label for="id_tahun_lulus">Tahun Lulus</label>
                                    <input type="text" class="form-control" id="id_tahun_lulus" name="id_tahun_lulus"
                                        placeholder="Tahun Lulus" value="" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-4 mb-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-4 mb-12">
                                    ...
                                    <input type="text" class="form-control" id="jawaban" name="jawaban" 
                                        placeholder="Jawaban" value="" required>
                                </div>
                            </div>
                            <button class="btn btn-primary waves-effect waves-light" type="submit">Simpan</button>
                            {{-- tombol batal --}}
                            <a href="{{ route('jawaban') }}" class="btn btn-secondary waves-effect waves-light">Batal</a>
                        </form>
